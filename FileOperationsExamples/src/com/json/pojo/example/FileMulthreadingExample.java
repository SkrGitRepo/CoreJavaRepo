...
public class FileMulthreadingExample {
	    
	    public static void main(String[] args) {
	        Thread.currentThread().setPriority(Thread.MIN_PRIORITY);
	        long startTime = System.nanoTime();
	        File dir = new File("/opt/brms/shared/scripts/Multifiles");
	        File destination = new File("c:/opt/brms/shared/scripts/Multifiles/DestinationMultiThread.txt");
